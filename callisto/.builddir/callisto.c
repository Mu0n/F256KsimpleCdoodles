#include "D:\F256\llvm-mos\code\callisto\.builddir\trampoline.h"
...
EMBED(embeddedCLUT,"../gfx/master07.pal", 0x20000);
EMBED(embedded16,  "../gfx/gfx16.bin",    0x30000);
EMBED(embedded32,  "../gfx/gfx32.bin",    0x40000);
