#include "D:\F256\llvm-mos\code\fileWrite4\.builddir\trampoline.h"
...
static bool
write_bytes(FILE *fp, void *bytes, size_t len, char **error)
{
...
static bool
write_file(char *fname,
           bool (*fn)(FILE *fp, char **error),
           char **error)
{
    FILE *fp;
    bool ret;
