...
int main(int argc, char *argv[]) {
	...
	bool midiChip = true; //true = vs1053b, false=sam2695
...
printf("\nTempoChange #:%d uspT=%lu at: %lu ticks",tempoChIndex, rec->myTempos.usPerTick[tempoChIndex],rec->myTempos.absTick[tempoChIndex]);
hitspace();
						tempoChIndex++;
...
printf("\ntr:%d at:%lu nextCh %02d at:%lu",currentTrack, superTotal[currentTrack], tempoChIndex, rec->myTempos.absTick[tempoChIndex]);
hitspace();
