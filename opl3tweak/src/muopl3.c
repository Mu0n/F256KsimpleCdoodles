...
opl3I opl3_instrument_defs[] = {
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x21,.OP1_TVSKF=0xC0,.OP2_KSLVOL=0x01,.OP1_KSLVOL=0x15,.OP2_AD=0xF4,.OP1_AD=0xF2,.OP2_SR=0x25,.OP1_SR=0x40,.OP2_WAV=0x04,.OP1_WAV=0x07,.CHAN_FEED=0x30}
	,
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x72,.OP1_TVSKF=0x71,.OP2_KSLVOL=0x00,.OP1_KSLVOL=0x48,.OP2_AD=0xF2,.OP1_AD=0xF1,.OP2_SR=0x27,.OP1_SR=0x53,.OP2_WAV=0x02,.OP1_WAV=0x00,.CHAN_FEED=0x30},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x23,.OP1_TVSKF=0x21,.OP2_KSLVOL=0x80,.OP1_KSLVOL=0x4D,.OP2_AD=0x72,.OP1_AD=0x71,.OP2_SR=0x06,.OP1_SR=0x12,.OP2_WAV=0x00,.OP1_WAV=0x01,.CHAN_FEED=0x30},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x21,.OP1_TVSKF=0x22,.OP2_KSLVOL=0x00,.OP1_KSLVOL=0x59,.OP2_AD=0xFF,.OP1_AD=0xFF,.OP2_SR=0x0F,.OP1_SR=0x03,.OP2_WAV=0x00,.OP1_WAV=0x02,.CHAN_FEED=0x30},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x00,.OP1_TVSKF=0x50,.OP2_KSLVOL=0x07,.OP1_KSLVOL=0x03,.OP2_AD=0xFF,.OP1_AD=0xFF,.OP2_SR=0x02,.OP1_SR=0x02,.OP2_WAV=0x00,.OP1_WAV=0x01,.CHAN_FEED=0x30},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x21,.OP1_TVSKF=0x21,.OP2_KSLVOL=0x80,.OP1_KSLVOL=0x8E,.OP2_AD=0x90,.OP1_AD=0xBB,.OP2_SR=0x0A,.OP1_SR=0x29,.OP2_WAV=0x00,.OP1_WAV=0x00,.CHAN_FEED=0x30},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x01,.OP1_TVSKF=0x07,.OP2_KSLVOL=0x48,.OP1_KSLVOL=0x1F,.OP2_AD=0xF5,.OP1_AD=0xF5,.OP2_SR=0xFA,.OP1_SR=0xFA,.OP2_WAV=0x00,.OP1_WAV=0x00,.CHAN_FEED=0x30},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x13,.OP1_TVSKF=0x00,.OP2_KSLVOL=0x00,.OP1_KSLVOL=0x10,.OP2_AD=0xF2,.OP1_AD=0xF2,.OP2_SR=0x72,.OP1_SR=0x72,.OP2_WAV=0x00,.OP1_WAV=0x00,.CHAN_FEED=0x30},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x11,.OP1_TVSKF=0x03,.OP2_KSLVOL=0x00,.OP1_KSLVOL=0x54,.OP2_AD=0xF1,.OP1_AD=0xF3,.OP2_SR=0xE7,.OP1_SR=0x9A,.OP2_WAV=0x00,.OP1_WAV=0x01,.CHAN_FEED=0x30},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0xF0,.OP1_TVSKF=0xF2,.OP2_KSLVOL=0x05,.OP1_KSLVOL=0x09,.OP2_AD=0x50,.OP1_AD=0x50,.OP2_SR=0x08,.OP1_SR=0x09,.OP2_WAV=0x01,.OP1_WAV=0x01,.CHAN_FEED=0x3B},
//Lemmings
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x01,.OP1_TVSKF=0x01,.OP2_KSLVOL=0x00,.OP1_KSLVOL=0x00,.OP2_AD=0xe3,.OP1_AD=0xc4,.OP2_SR=0x04,.OP1_SR=0x05,.OP2_WAV=0x01,.OP1_WAV=0x03,.CHAN_FEED=0x31},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x22,.OP1_TVSKF=0x22,.OP2_KSLVOL=0x08,.OP1_KSLVOL=0x08,.OP2_AD=0x51,.OP1_AD=0x83,.OP2_SR=0x88,.OP1_SR=0x88,.OP2_WAV=0x00,.OP1_WAV=0x01,.CHAN_FEED=0x38},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x00,.OP1_TVSKF=0x00,.OP2_KSLVOL=0x00,.OP1_KSLVOL=0x00,.OP2_AD=0xE9,.OP1_AD=0xE9,.OP2_SR=0x05,.OP1_SR=0x07,.OP2_WAV=0x00,.OP1_WAV=0x02,.CHAN_FEED=0x3D},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x01,.OP1_TVSKF=0x01,.OP2_KSLVOL=0x00,.OP1_KSLVOL=0x00,.OP2_AD=0x99,.OP1_AD=0xA9,.OP2_SR=0x08,.OP1_SR=0x03,.OP2_WAV=0x00,.OP1_WAV=0x02,.CHAN_FEED=0x3E},
//Wacky Wheels	
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x21,.OP1_TVSKF=0x21,.OP2_KSLVOL=0x0,.OP1_KSLVOL=0x1D,.OP2_AD=0x81,.OP1_AD=0x71,.OP2_SR=0x9E,.OP1_SR=0xAE,.OP2_WAV=0x00,.OP1_WAV=0x00,.CHAN_FEED=0x3E},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0xE0,.OP1_TVSKF=0xF0,.OP2_KSLVOL=0x0,.OP1_KSLVOL=0x93,.OP2_AD=0xF0,.OP1_AD=0xF5,.OP2_SR=0x44,.OP1_SR=0x59,.OP2_WAV=0x3,.OP1_WAV=0x3,.CHAN_FEED=0x3E},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x1,.OP1_TVSKF=0x50,.OP2_KSLVOL=0x0,.OP1_KSLVOL=0x0,.OP2_AD=0xF3,.OP1_AD=0xFA,.OP2_SR=0x7A,.OP1_SR=0x71,.OP2_WAV=0x00,.OP1_WAV=0x1,.CHAN_FEED=0x30},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x0,.OP1_TVSKF=0x0,.OP2_KSLVOL=0x0,.OP1_KSLVOL=0xD,.OP2_AD=0xA5,.OP1_AD=0xE8,.OP2_SR=0xFF,.OP1_SR=0xEF,.OP2_WAV=0x00,.OP1_WAV=0x00,.CHAN_FEED=0x36},
	
//Ultima Underworld - Descent
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x12,.OP1_TVSKF=0x17,.OP2_KSLVOL=0x28,.OP1_KSLVOL=0x4F,.OP2_AD=0xF2,.OP1_AD=0xF2,.OP2_SR=0x74,.OP1_SR=0x61,.OP2_WAV=0x00,.OP1_WAV=0x00,.CHAN_FEED=0x38},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x00,.OP1_TVSKF=0x61,.OP2_KSLVOL=0x0,.OP1_KSLVOL=0x1E,.OP2_AD=0x66,.OP1_AD=0xF5,.OP2_SR=0x5A,.OP1_SR=0x00,.OP2_WAV=0x0,.OP1_WAV=0x00,.CHAN_FEED=0x32},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x62,.OP1_TVSKF=0x21,.OP2_KSLVOL=0x8D,.OP1_KSLVOL=0x83,.OP2_AD=0x65,.OP1_AD=0x74,.OP2_SR=0x17,.OP1_SR=0x17,.OP2_WAV=0x00,.OP1_WAV=0x00,.CHAN_FEED=0x37},
	{.VT_DEPTH=0x00, .OP2_TVSKF=0x21,.OP1_TVSKF=0x21,.OP2_KSLVOL=0x14,.OP1_KSLVOL=0x26,.OP2_AD=0x7F,.OP1_AD=0x61,.OP2_SR=0xA,.OP1_SR=0x6A,.OP2_WAV=0x00,.OP1_WAV=0x00,.CHAN_FEED=0x32}
...
void opl3_setInstrumentAllChannels(uint8_t which)
{
	...
	for(c=0;c<9;c++)
	{
	opl3_setInstrument(opl3_instrument_defs[which],c); //operators
	opl3_write((uint16_t)OPL_CH_FEED | (uint16_t)c,   opl3_instrument_defs[which].CHAN_FEED); //channel
	}	
	for(c=0;c<9;c++)
	{
	opl3_setInstrument(opl3_instrument_defs[which],c+9);//operators
	opl3_write(0x0100 | (uint16_t)OPL_CH_FEED | (uint16_t)c,   opl3_instrument_defs[which].CHAN_FEED);//channel
	}
}
