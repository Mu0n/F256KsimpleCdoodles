#include "D:\F256\llvm-mos\code\sfx\.builddir\trampoline.h"
...
EMBED(bong, "../assets/blip.wav", 0x20000);//6,220 bytes
...
/*
		lowVol();
		for (uint16_t i = 0; i < 2048; i++)  POKE(VS_FIFO_DATA,0x00); //preroll
		highVol();
*/
